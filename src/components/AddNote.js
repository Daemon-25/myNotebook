            ...
            <div className='container my-3'>
                <form className='my-3'>
                    <div className="mb-3">
                        ...
                        <input type="text" className="form-control" id="title" name="title" aria-describedby="emailHelp" value={note.title} onChange={handleOnChange} minLength={3} required/>
                    </div>
                    <div className="mb-3">
                    ...
                    <button disabled={note.title.length<3 || note.description.length<5} type="submit" className="btn btn-dark" onClick={handleAddNote}>Add Note</button>
                </form>
            </div>
        </>
    )
